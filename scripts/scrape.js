...
var scrape = function() {
  ...
  return axios.get("https://www.dcuniverse.com/browse/encyclopedia").then(function(res) {
    ...
    $(".thumbnal__title").each(function(i, element) {
      ...
      if (head && sum && url) {
        ...
        var dataToAdd = {
          headline: headNeat,
          summary: sumNeat,
          url: "https://www.dcuniverse.com/browse/encyclopedia" + url
        };
